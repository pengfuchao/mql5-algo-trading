...
*   **`Support_Resistance_Channels.mq5`**
    ...
    *   **參數**: `PivotPeriod` (4–30)、`Source` (High/Low 或 Close/Open)、`ChannelWidthPct` (1–8)、`MinStrength`、`MaxNumSR` (1–10，沿用原版顯示語意)、`Loopback` (100–400)、三色設定、`ShowPivot`、`ShowBroken`、`ShowBounce`、`AlertsOn`，以及兩條可選 MA (SMA/EMA)。
    ...
    *   **實作說明 / 限制**:
        ...
        *   新增反彈 buffer 後需重新以 MetaEditor 編譯確認。
