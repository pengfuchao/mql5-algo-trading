...
| London Breakout（亞洲盤區間突破，GBPUSD M15） | [London_Breakout_Asian_Range.md](London_Breakout_Asian_Range.md) | **已驗證／否定**：GBPUSD/EURUSD baseline 否定；USDJPY 通過 OOS 但成本關卡失敗，結案。狀態以 [Strategy_Records](../Strategy_Records/Strategy_Session_Range.md) 為準 |
...
| 黃金日內季節性（亞洲漲/歐美跌，XAUUSD H1） | [Gold_Intraday_Seasonality.md](Gold_Intraday_Seasonality.md) | **已驗證／否定**：成本關卡不通過（edge 0.110 < 成本 0.29 USD/oz），逐年 6/9 年為負，結案；見 [Strategy_Records](../Strategy_Records/Strategy_Time_Window.md) |
