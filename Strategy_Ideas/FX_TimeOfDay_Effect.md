...
狀態：Phase 0 broker cost gate 已正式 GO；conditional Phase 1 EA 已實作，待 smoke test 與正式回測（**有正式學術文獻支持**，repo 目前唯一有 peer-reviewed 依據的候選）
